    ...
    <div class="layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="d-flex">
                ...
                <div id="flash-data" data-keterangan="{{ session()->get('success') }}"></div>

                <h4 class="mr-2">Surat Keterangan</h4>
                <a href="{{ route('surat.keterangan.create') }}" class="align-items-center">
            ...
            <div class="widget-content widget-content-area br-6">
                <div class="table-responsive mb-4 mt-4" style="overflow-x: hidden;">
                    ...
                    <livewire:surat-keterangan.data-table>
