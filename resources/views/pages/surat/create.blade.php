                        ...
                        <div class="row">
                            {{-- <div class="col-xl-3">
                                <div class="custom-file-container" data-upload-id="myFirstImage">
                                    ...
                                    @enderror
                                    <input name="link_file" type="file" id="input-file-max-fs" class="dropify" data-default-file="{{ asset('cork/assets/img/upload-dokumen.png') }}" data-max-file-size="2M" data-height="300" data-allowed-file-extensions="pdf doc docx" />
                                </div>
                            </div> --}}
                            <div class="col-xl-12">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="link_file" placeholder="https://drive.google.com/file/d/1IaDz-Vbuq4NLJ1S1EuzRrLe4kXdLhZSA/view?usp=sharing" name="link_file">
                                        @error('link_file')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="tentang" placeholder="Lorem ipsum dolor sit..." name="tentang">
                                        @error('tentang')
                                        <div class="mt-2 text-danger">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="basicFlatpickr" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date.." name="tanggal_surat">
                                        @error('tanggal_surat')
                                        <div class="mt-2 text-danger">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="pejabat" placeholder="Wahyu Syahputra" name="pejabat">
                                        @error('pejabat')
                                        <div class="mt-2 text-danger">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="jabatan_pejabat" placeholder="Rektor" name="jabatan_pejabat">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="basicFlatpickr2" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date.." name="tanggal_mulai">
                                        @error('tanggal_mulai')
                                        <div class="mt-2 text-danger">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="basicFlatpickr3" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date.." name="tanggal_akhir">
                                        @error('tanggal_akhir')
                                        <div class="mt-2 text-danger">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="form-group mb-12 ml-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" cols="98" name="deskripsi_surat"></textarea>
                                    </div>
...
<script>
    ...
    var f3 = flatpickr(document.getElementById('basicFlatpickr3'));
</script>
@endpush