    ...
    <table id="default-ordering" class="table table-hover" style="width:100%;">
        <thead>
            <tr class="text-center">
                <th>#</th>
                <th wire:click="sortBy('tentang')" style="cursor: pointer;">
                    Tentang

                    @include('partials._sort-icon', ['field' => 'tentang_surat'])
                </th>
                ...
                <th wire:click="sortBy('tanggal_surat')" style="cursor: pointer;">
                    Ditetapkan

                    @include('partials._sort-icon', ['field' => 'tanggal_surat'])
                </th>
                <th wire:click="sortBy('jenis_surat')" style="cursor: pointer;">
                    Jenis Surat

                    @include('partials._sort-icon', ['field' => 'jenis_surat'])
                </th>
                <th>E-Doc</th>
                @inputsurat('staf')
                <th>Aksi</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $document->tentang }}</td>
                <td class="text-center">{{ $document->no_surat }}</td>
                <td class="text-center">{{ $document->tanggal_surat }}</td>
                <td class="text-center">{{ $document->jenis_surat }}</td>
                <td class="text-center">
                    <a href="{{ $document->link_download }}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Unduh">
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        ...
                        <h6 class="text-muted ml-1">{{ $tentang }}</h6>
